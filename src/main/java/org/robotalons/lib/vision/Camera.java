...
//TODO: Return values that we want to return
// -----------------------------------------------------------------[Camera]----------------------------------------------------------------//
/**
 *
 *
...
public abstract class Camera implements Closeable {
   ...
   */
  public abstract double[] getRobotPositionTimestamps();
   ...
   */
  public abstract Pose2d[] getRobotPositionDeltas();
   ...
   */
  public abstract Transform3d getRobotOffset();
