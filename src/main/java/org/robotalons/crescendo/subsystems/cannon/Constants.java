...
public class Constants {
  ...
  public static final class Ports {
    public static final int FIRING_CONTROLLER_RIGHT_ID = (34);
    public static final int FIRING_CONTROLLER_LEFT_ID = (35);
    public static final int INTAKE_CONTROLLER_ID = (21);
    public static final int INDEXER_CONTROLLER_ID = (22);
    public static final int PIVOT_CONTROLLER_ID = (32);
    public static final int PIVOT_ABSOLUTE_ENCODER_ID = (0);
  }
