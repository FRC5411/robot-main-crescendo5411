...
public class Constants {
  ...
  public static final class Measurements {
    ...
    public static final Transform3d RIGHT_CAMERA_CAMERA_POSE = new Transform3d(
      new Translation3d(ROBOT_RADIUS_METERS, new Rotation3d()), new Rotation3d((0d), (0.6108652d), (0.7853982d)));
    
    public static final Transform3d LEFT_CAMERA_CAMERA_POSE = new Transform3d(
      new Translation3d(ROBOT_RADIUS_METERS, new Rotation3d()), new Rotation3d((0d), (0.6108652d), (-0.7853982d)));
  ...
  public static final class Ports {
    ...
    public static final String RIGHT_CAMERA_NAME = ("SPEAKER_RIGHT");    
    public static final String LEFT_CAMERA_NAME = ("SPEAKER_LEFT");    
    public static final String INTAKE_CAMERA_NAME = ("INTAKE");    
  }
  ...
  public static final class Devices {
    public static PhotonCamera SOURCE_CAMERA = (null);
    public static PhotonCamera SPEAKER_RIGHT_CAMERA = (null);
    public static PhotonCamera SPEAKER_LEFT_CAMERA = (null);
    public static PhotonCamera INTAKE_CAMERA = (null);
  }
}
